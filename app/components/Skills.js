...
export default function Skills(){
  return(
    <div id="skills" className="flex flex-col w-full h-dvh md:h-screen min-h-dvh md:h-screen snap-start bg-gradient-to-b from-purple-700 via-purple-200 to-white">
