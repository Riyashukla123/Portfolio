...
export default function Services({proView, ind, setProView, setInd}){
  ...
  return(
   <div id="services" className="relative flex flex-col w-full h-dvh md:h-screen min-h-dvh snap-start bg-purple-700">
    ...
    {proView && <Projects setProView={setProView} setInd={setInd} data = {Data[ind]}/>} 
   </div>
  );
}